    ...
    <div className='container mx-auto px-4 lg:px-0'>
      ...
      '>
        <div className='shrink-0 block lg:hidden'>
          <Image height={32} width={32} src='/images/logo/logo.png' alt='Logo' className='w-8' />
        </div>
        <div className='sm:relative flex-1 lg:mx-0'>
          <ul
            ...
            <li className='lg:px-1 cursor-pointer hover:text-white text-primary lg:w-auto w-full'>
              <a href='#home' className='py-3 px-3 inline-block w-full'>
                Home
              </a>
            </li>
            <li className='lg:px-1 cursor-pointer hover:text-white text-primary lg:w-auto w-full'>
              <a href='#case-studies' className='py-3 px-3 inline-block w-full'>
                Case Studies
              </a>
            </li>
            <li className='lg:px-1 cursor-pointer hover:text-white text-primary lg:w-auto w-full'>
            ...
            <li className='lg:px-1 cursor-pointer hover:text-white text-primary lg:w-auto w-full'>
              <a href='#recent-work' className='py-3 px-3 inline-block w-full'>
                Recent work
              </a>
            </li>
            <li className='lg:px-1 cursor-pointer hover:text-white text-primary lg:w-auto w-full'>
              <a href='#getIn-touch' className='py-3 px-3 inline-block w-full'>
                Get In Touch
              </a>
            </li>
